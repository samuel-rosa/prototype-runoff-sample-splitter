...
O teste realizado com o método do mergulho mostrou que o mesmo não proporcionou a obtenção de amostras representativas das suspensões usadas (Tabela \@ref(tab:mergulho-solidos)). Uma subestimativa estatisticamente significativa de 30% ou mais da concentração de sólidos totais foi observada em todas as três concentrações avaliadas. Além disso, uma variação considerável entre as repetições foi observada. Esses resultados corroboram a suspeita inicial, a qual fora levantada com base nos resultados obtidos em trabalhos realizados em outras condições ambientais [@Lang1992; @ZoebischEtAl1996; @CiesiolkaEtAl2006; @TodiscoEtAl2012; @Kinnell2016].
...
Uma subestimativa significativa da concentração de sólidos totais reflete a limitada consistência do método do mergulho na amostragem de enxurrada. Isso ocorre porque, devido à sedimentação diferencial, marcada pela rápida decantação das partículas de areia, ocorre a amostragem seletiva das partículas mais finas, nesse caso silte e argila. Isso sugere que as estimativas de perda de solo anual em áreas com solo de granulometria grosseira podem ser até 30% inferiores às perdas reais. Ademais, é de se esperar que a distribuição do tamanho de partículas e a composição química do sedimento das amostras sejam significativamente diversas da enxurrada.
<!-- ASR: Precisamos avaliar as estimativas de perda de solo obtidas nos trabalhos de monitoramento citados na introdução. -->
