...
A erosão do solo constitui, há muitas décadas, uma das maiores preocupações dos cientistas do solo [@PanagosEtAl2017]. Prova disso são as milhares de parcelas de monitoramento da erosão, instaladas sob os mais diferentes tipos de solo e usos da terra, distribuídas ao redor de todo o planeta [@Garcia-RuizEtAl2015; @AnacheEtAl2017]. No Brasil, estima-se que a perda anual de solo seja de aproximadamente 500 milhões de toneladas, com impactos negativos diretos sobre a qualidade dos agroecossistemas e a sustentabilidade das atividades humanas [Bertoni e Lombardi Neto, 2010].

<!-- ASR: Poderíamos incluir estimativas sobre o impacto da erosão, como a quantidade de solo perdido. Quanto à descrição da parcela padrão, apesar da recomendação anterior, creio que não seja pertinente. Boix-FayosEtAl2006 descreve que uma das principais fontes de variação é o tamanho da parcela, ou seja, a escala espacial de medida da erosão. Talvez devêssemos mencionar as fontes de variação descritas nos trabalhos citados. Acho que a última frase não é pertinente. Em resumo, esse parágrafo poderia mostrar o problema da erosão, seus impactos, que tentamos medir as perdas de solo, mas que diversas fontes de variação determinam que nossa incerteza sobre a magnitude das perdas de solo seja relativamente grande. As referências citadas são suficientes. -->
