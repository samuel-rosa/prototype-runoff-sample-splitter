...
panderOptions('digits', rep(4, ncol(d)))
panderOptions('table.split.cells', rep(100 / ncol(d), ncol(d)))
pander(d, caption = '(\\#tab:fracionador-agua) Dados e estatísticas do volume de água das amostras produzidas pelas saídas A e B do fracionador para volumes iniciais de 100, 300, 500 e 1000 mL. Estatísticas: DP -- desvio padrão, CV -- coeficiente de variação, EM -- erro médio, *t* -- estatística do teste *t*, *P* -- valor *P* do teste *t*.')
```
