...
where _s~j~_ is the sample standard deviation of the estimation error. The exact _P_-value of the _t_-test, the probability of finding a difference equal or more extreme than that observed when the null hypothesis is true, was obtained from the Student's t distribution function with _n_ - 1 degree of freedom.
