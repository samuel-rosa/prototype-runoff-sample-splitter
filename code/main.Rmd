...
# Download limits of neighbouring South American countries
if (!file.exists("../data/vector/america.shp")) {
  gdalUtils::ogr2ogr(
    src_datasource_name = "WFS:http://www.geoservicos.ibge.gov.br:80/geoserver/wfs", 
    dst_datasource_name = "../data/vector/america.shp",
    layer = "CGEO:AtlasMar_AmericaDoSul")
  america <- 
    sf::st_read("../data/vector/america.shp") %>% 
...
brasil %<>% mutate(col = ifelse(NomUF == "Rio Grande do Sul", "gray25", "white"))
...
# Plot
plot(
  brasil[brasil$NomUF == "Rio Grande do Sul", "NomUF"], reset = FALSE, main = "", axes = TRUE, col = "gray90",
  graticule = TRUE)
plot(rs["id"], border = "transparent", col = rs$col, reset = FALSE, add = TRUE)
plot(brasil, add = TRUE, reset = FALSE, col = "transparent")
# plot(america, add = TRUE, reset = FALSE, col = "transparent")
points(-53.71327, -29.71289, pch = 20, col = "red")
