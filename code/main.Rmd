...
panderOptions('digits', rep(4, ncol(d)))
panderOptions('table.split.cells', rep(100 / ncol(d), ncol(d)))
pander(d, caption = '(\\#tab:fracionador-areia) Dados e estatísticas do conteúdo de argila nos sólidos totais das amostras obtidas usando o método do fracionador de três suspensões com concentração de sólidos totais de 2, 10 e 50 g L^-1^. Estatísticas: DP -- devio padrão, CV -- coeficiente de variação, EM -- erro médio, *t* -- estatística do teste *t*, *p* -- valor *p* do teste *t*.')
```
