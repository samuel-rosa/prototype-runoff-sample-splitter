...
```{r sample-splitter, echo=FALSE, fig.cap="Prototype sample splitter compared to the manual method. The constituent PVC and wooden parts and their dimensions (unscalled) are shown in detail.", fig.align='center', out.width='16.5cm'}
