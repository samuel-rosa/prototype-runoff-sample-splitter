...
**RESUMO**: O método usado para obtenção das amostras de enxurrada coletada em parcelas de monitoramento da
...
devem a homogeneização ineficiente que facilita a sedimentação diferencial das partículas de diferentes tamanhos.
Caso esses problemas sejam encontrados também em outros estudos, o protótipo que desenvolvemos apresenta-se 
...
suspesão foi vertida no reservatório do fracionador de uma só vez. O fracionador foi lavado com água destilada
...
também em outros estudos, o protótipo que desenvolvemos apresenta-se como uma alternativa bastante razoável. 
