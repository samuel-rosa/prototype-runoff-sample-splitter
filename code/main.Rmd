...
Os resultados do primeiro teste realizado com o protótipo que desenvolvemos mostraram que a eficiência do mesmo não é afetada pelo volume de água (Tabela \@ref(tab:fracionador-agua)). Ambas as saídas A e B produziram amostras com volumes similares. Contudo, o processo de fracionamento parece tornar-se menos eficiente com a diminuição do volume de água. Aparentemente, os maiores erros percentuais (negativos ou positivos) observados quando o volume de amostra era pequeno, foram resultado do efeito turbilhão da água no interior do cano de 15 mm de diâmetro localizado abaixo do reservatório. A função desse cano é dirigir a água em um fluxo constante até o dispositivo fracionador. Parece-nos que esse objetivo só foi efetivamente atingido quando o volume de água era superior a 100 mL. Assim, é razoável que o protórito seja utlizado apenas para fracionar suspensões de volume superior a 250-300 mL.
