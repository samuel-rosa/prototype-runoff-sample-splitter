...
perfil <- febr::layers("ctb0013", progress = FALSE)
str(perfil)
# dplyr::select(perfil, "camada_nome", "profund_sup", "profund_inf") %>% 
  # knitr::kable(
    # booktabs = TRUE,
